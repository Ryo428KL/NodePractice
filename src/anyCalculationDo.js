...
const FomulaErr4 = '100 > 1'; // 返却値がNumber型以外
...
const res3_er4 = calc.anyCalc(Nums3, FomulaErr4);
...
console.log('res3_er1:', res3_er1, ' res3_er2:', res3_er2, ' res3_er3:', res3_er3, ' res3_er4:', res3_er4);
